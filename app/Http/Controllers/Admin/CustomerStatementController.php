...
class CustomerStatementController extends Controller
{
    ...
    public function print(Request $request)
    {
        ...
        $pdf = PDF::loadView('admin.customerStatement.print',['title'=>$title,'fromDate'=>$fromDate,'toDate'=>$toDate,'previousBalances'=>$previousBalances,'customerStatements'=>$customerStatements]);
