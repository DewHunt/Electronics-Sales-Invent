            ...
            <div class="col-md-12">
                                	...
                                	@foreach ($liftingProducts as $liftingProduct)
                                		...
                                		<tr id="itemRow_{{ $i }}">                
							                <td>
							                	...
							                	<input class="productName_{{ $i }}" type="text" name="productName[]" value="{{ $liftingProduct->productName }}" required>
							                </td>
							                <td>
							                ...
							                <td>
							                	<input class="productSerialNo_{{ $i }}" type="text" name="productSerialNo[]" value="{{ $liftingProduct->serial_no }}" required>
							                </td>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input style="text-align: right;" class="form-control totalHairePrice" type="number" name="totalHairePrice" value="{{ $lifting->total_haire_price }}" readonly>
                        </div>
                    </div>
                </div>
            </div>
