            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group {{ $errors->has('serialNo') ? ' has-danger' : '' }}">
                            <input type="text" class="form-control" name="serialNo" value="{{ $lifting->serial_no }}" required readonly/>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group {{ $errors->has('voucharNo') ? ' has-danger' : '' }}">
                            <input type="text" class="form-control" name="voucharNo" value="{{ $lifting->vaouchar_no }}" required>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group {{ $errors->has('purchaseBy') ? ' has-danger' : '' }}">
                            <input  type="text" class="form-control" name="purchaseBy" value="{{ $lifting->purchase_by }}" required readonly>
                                ...
                                <tbody id="tbody">
                                	...
                                	@foreach ($liftingProducts as $liftingProduct)
                                		...
                                		<tr id="itemRow_{{ $i }}">                
							                ...
							                <td>
							                	<input class="productModel_{{ $i }}" type="text" name="productModel[]" value="{{ $liftingProduct->model_no }}" required readonly>
							                </td>
							                <td>
							                	<input class="productColor_{{ $i }}" type="text" name="productColor[]" value="{{ $liftingProduct->color }}" readonly>
							                </td>
							                <td>
							                ...
							                <td>
							                    ...
							                    <input style="text-align: right;" class="productPrice productPrice_{{ $i }}" type="number" name="productPrice[]" value="{{ $liftingProduct->price }}" required readonly>
						                        <input class="productMrpPrice_{{ $i }}" type="hidden" name="productMrpPrice[]" value="{{ $liftingProduct->mrp_price }}" required>
						                        <input class="productHairePrice_{{ $i }}" type="hidden" name="productHairePrice[]" value="{{ $liftingProduct->haire_price }}" required>
							                </td>
							                <td align="center">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                        	<input style="text-align: right;" class="form-control totalQty" type="number" name="totalQty" value="{{ $lifting->total_qty }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group {{ $errors->has('productId') ? ' has-danger' : '' }}">
                        	...
                        	<input style="text-align: right;" class="form-control totalMrpPrice" type="hidden" name="totalMrpPrice" value="{{ $lifting->total_mrp_price }}" readonly>
                        	<input style="text-align: right;" class="form-control totalHairePrice" type="hidden" name="totalHairePrice" value="{{ $lifting->total_haire_price }}" readonly>
                        </div>
                    </div>
                </div>
            </div>
