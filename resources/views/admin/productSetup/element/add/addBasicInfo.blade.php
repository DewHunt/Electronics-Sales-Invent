	            	...
	            	<div class="row">
	            		...
	            		<div class="col-md-6">
	                        ...
	                        <div class="form-group {{ $errors->has('mrpPrice') ? ' has-danger' : '' }}">
	                            <input type="text" class="form-control form-control-danger" id="mrpPrice" name="mrpPrice" value="0" required>
	                ...
	                <div class="row">
	                    <div class="col-md-6">
	                        ...
	                        <div class="form-group {{ $errors->has('hairePrice') ? ' has-danger' : '' }}">
	                            <input type="text" class="form-control form-control-danger" id="hairePrice" name="hairePrice" value="0">
	        		...
	        		<div class="row">
	        			...
	        			<div class="col-md-6">
	                        ...
	                        <div class="form-group {{ $errors->has('transportPoint') ? ' has-danger' : '' }}">
	                            <input type="number" class="form-control form-control-danger" name="transportPoint" value="{{ old('transportPoint') }}" required>
